...
Install_Bt(){
	...
	# cp /root/public.sh /www/server/panel/install/public.sh
	wget -O /www/server/panel/install/public.sh https://raw.githubusercontent.com/crudguy/bt/refs/heads/main/public.sh -T 15
	echo "=============================================="
	echo "正在下载面板文件,请稍等..................."
	echo "=============================================="
	# wget -O panel.zip ${Btapi_Url}/install/src/panel6.zip -T 15
	# cp /root/panel6.zip panel.zip
	wget -O panel.zip https://github.com/crudguy/bt/releases/download/panel/panel.zip -T 15
